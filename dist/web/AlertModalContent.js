...
var AlertModalContent = (function (_super) {
    ...
    AlertModalContent.prototype.render = function () {
        ...
        var buttons = this.props.buttons.map(function (btnSpec, i) {
            var isCancel = btnSpec.style === 'cancel';
            var buttonStyle = [_styles.defaultButton, isCancel && _styles.defaultCancelButton];
            var buttonTextStyle = [_styles.defaultBtnText, isCancel && _styles.defaultCancelBtnText];
